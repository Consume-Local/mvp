<template>
  <article
    ...
    <div class="flex justify-between items-center pb-4">
      ...
      <span class="inline-block text-center text-sm p-1 rounded bg-gray-200 font-semibold">{{ category }}</span>
    </div>
    ...
    <div class="-mx-1">
      <span class="bg-green-100 inline-block rounded-full m-1 px-3 py-1 border border-green-200 text-xs font-semibold text-green-800"
        v-if="hasTakeOut">
